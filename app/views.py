...
def data_page(request):
    return render(request, 'app/data_page.html')    
...
#
#    # Example: Data cleansing and documenting
#    # Assuming some data cleaning steps, e.g., removing duplicates
#    cleaned_data = df.drop_duplicates()
#
#    # Example: Aggregating data
#    avg_measurements = cleaned_data.groupby('species').mean()
#    
...
#    plot_path = os.path.join(settings.STATICFILES_DIRS[0], 'moons_plot.png')
...
#    plot_path = os.path.join(settings.STATICFILES_DIRS[0], 'Correlation_Matrix.png')
#    plt.savefig(plot_path)
#    plt.close()  # Close the plot to free up memory
#
#    # Pair plot
...
#
#    context = {
#        'data_summary': cleaned_data.head(),  # Summary of cleaned data
#        'aggregated_data': avg_measurements.to_html(),  # Display aggregated data
#        'moons_plot_url': 'moons_plot.png', 
#        'cal_housing' : data.head(25),
#        'Correlation_Matrix_url':'Correlation_Matrix.png',
#        'Distribution_of_Median_House_Value_url':'Distribution_of_Median_House_Value.png',
#        'Feature_Importance_from_Random_Forest_url' : 'Feature_Importance_from_Random_Forest.png',
